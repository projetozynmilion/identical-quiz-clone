        ...
        <div className="max-w-[1400px] mx-auto px-5 h-16 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0">
            <div
              ...
              style={{ background: "linear-gradient(135deg, #0a84ff, #0044cc)" }}
            >
          ...
          <div className="flex items-center gap-2">
            {isAdmin && (
              <button
                ...
                style={{ background: "linear-gradient(135deg,#0a84ff,#0044cc)", color: "#fff" }}
              >
      ...
      <main className="relative z-10 max-w-[1400px] mx-auto px-5 pb-24 space-y-14">
        ...
        {!loading && rows.every((r) => r.items.length === 0) && (
          ...
          >
            ...
            {isAdmin && (
              <div className="mt-4">
                <button onClick={() => setAdminOpen(true)} className="inline-flex items-center gap-1.5 h-10 px-4 rounded-xl text-[13px] font-semibold" style={{ background: "linear-gradient(135deg,#0a84ff,#0044cc)", color: "#fff" }}>
    ...
    >
      ...
      <div className="p-4 sm:p-5 flex flex-col gap-3">
        ...
        <button
          ...
          style={{
            background: copied ? "rgba(0,180,120,0.15)" : "linear-gradient(135deg,#0a84ff,#0044cc)",
