  ...
  return (
    <section className="max-w-7xl mx-auto px-5 py-24">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="font-display text-[30px] sm:text-[56px] leading-[0.95] uppercase mt-4 text-white">
      ...
      <div className="max-w-7xl mx-auto px-5 py-24">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
          <div>
            ...
            <h2 className="font-display text-[30px] sm:text-[60px] leading-[0.95] uppercase mt-4 text-white">
    ...
    <section className="bg-black relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-5 py-24 relative">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="font-display text-[30px] sm:text-[56px] leading-[1] uppercase mt-4 text-white">
    ...
    <section id="entrega" className="relative bg-[var(--ink)] scroll-mt-20">
      <div className="max-w-7xl mx-auto px-5 py-24">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="font-display text-[30px] sm:text-[64px] leading-[0.95] uppercase mt-4 text-white">
