          ...
          <div className="relative lg:flex lg:min-h-0 lg:flex-col">
            ...
            <div className="relative p-4 sm:p-6 lg:min-h-0 lg:flex-1 lg:overflow-y-auto lg:p-7 text-white custom-scroll">
              <div className="flex flex-wrap items-center gap-2 mb-4">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#0a84ff]/15 border border-[#0a84ff]/30 text-[#0a84ff] text-[10px] font-bold uppercase tracking-[0.18em]">
              ...
              {current && (
                <p className="mt-2 text-[#0a84ff] text-[15px] sm:text-[16px] font-semibold">{current.title}</p>
              )}
              {mod.subtitle && (
                ...
                <div className="mt-6 p-5 rounded-2xl bg-white/[0.03] border border-white/5">
                  <div className="flex items-end justify-between mb-3">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-[#0a84ff] text-base font-bold ml-0.5">%</span>
                    </div>
                  </div>
                  <div className="relative h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        background: "linear-gradient(90deg, #0a84ff 0%, #5f8cff 100%)",
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-[1fr_1fr_auto] gap-3">
                <button
                  onClick={markAndNext}
                  disabled={!current}
                  className="group inline-flex items-center justify-center gap-2 px-6 py-4 rounded-2xl bg-[#0a84ff] hover:bg-[#386dff] text-white font-bold text-[14px] transition-all active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed"
                ...
                return (
                  <button
                    ...
                    className={`group w-full text-left mb-1.5 px-3 py-3 rounded-xl flex items-center gap-3 transition-all ${
                      active
                        ? "bg-[#0a84ff]/12 border border-[#0a84ff]/30"
