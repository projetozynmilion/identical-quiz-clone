      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between px-6 h-16 border-b" style={{ background: B.bg, borderColor: B.border }}>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg grid place-items-center" style={{ background: "linear-gradient(135deg,#1f6dff,#0044cc)" }}>
        ...
        <div className="p-6 space-y-8">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <button
              ...
              style={{ background: "linear-gradient(135deg,#1f6dff,#0044cc)", color: "#fff", opacity: saving ? 0.6 : 1 }}
            >
